...
| Project | Count | Value |
|----------|-------|-------|
| Ergo Platform Core | 82 | 45,641.84 ERG |
| Rosen Bridge | 6 | 112.88 ERG |
| ChainCash Labs | 9 | 626.54 ERG |
| StabilityNexus | 2 | 127.29 ERG |
| Input-Output | 1 | 636.46 ERG |
| **Total** | **100** | **47,145.01 ERG** |

### Featured Opportunities

| Task | Value | Repository |
|----------|-------|-------|
| [NiPoPoW powered bootstrapping](https://github.com/ergoplatform/ergo/issues/1365) | 6,364.56 ERG | ergoplatform/ergo |
| [Add Python bindings](https://github.com/ergoplatform/sigma-rust/issues/780) | 954.68 ERG | ergoplatform/sigma-rust |
| [Keystone Wallet Integration](https://discord.com/channels/668903786361651200/669989266478202917/1344310506277830697) | 3,000 ERG | External |
...
Bounties are updated daily via GitHub Actions. Values shown in ERG equivalent. Some bounties may be paid in other tokens as noted in the detailed listings.
...
**[📝 View the Detailed Guide for Adding Bounties →](/docs/submission-guide.md)**
...
This repository uses GitHub Actions to automatically track and update bounties across the Ergo ecosystem. The system scans repositories, identifies issues with bounty tags, extracts bounty amounts, and generates updated reports daily.

**[🔧 Learn More About How The Repository Works →](/docs/how-it-works.md)**
